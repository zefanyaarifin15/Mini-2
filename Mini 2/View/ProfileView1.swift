            ...
            VStack{
                ...
                ScrollView(.vertical, showsIndicators: false, content: {
                    VStack{
                        ...
                        // Add New Post Button
//                        Button(action: {
//                            viewModel.addPost(username: "beautyjasmine", caption: "New post", location: "Location", postImage: "post7", profileImage: "beautyjasmine", initialLikes: 123, commentUser: "NewUser", commentText: "New comment")
//                        }) { -- cara pake functionnya
//                            Text("Add New Post")
