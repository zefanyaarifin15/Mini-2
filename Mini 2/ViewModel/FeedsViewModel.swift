...
class FeedsViewModel: ObservableObject {
    @Published var posts: [Post] = [
        Post(username: "beautyjasmine", caption: "beauty Mascara🫶🏻", location: "Studio", postImage: "post1", profileImage: "post6", initialLikes: 811234, commentUser: "ShadowLurker", commentText: "That lips look like pongo lips"),
        Post(username: "beautyjasmine", caption: "luv this product🫶🏻", location: "Studio", postImage: "post2", profileImage: "post6", initialLikes: 214321, commentUser: "ShadowLurker", commentText: "Are you always at the studio?"),
        Post(username: "beautyjasmine", caption: "With the  gurl!🫶🏻", location: "Studio", postImage: "post3", profileImage: "post6", initialLikes: 246789, commentUser: "ShadowLurker", commentText: "That pose again? not creative LOL"),
...
//        Post(username: "beautyjasmine", caption: "Eiffel Tower🌸", location: "Paris", postImage: "post5", profileImage: "beautyjasmine", initialLikes: 398567, commentUser: "ShadowLurker", commentText: "I bet you don’t even like the view."),
        Post(username: "beautyjasmine", caption: "Favorite pose🫶🏻", location: "Cafe", postImage: "post6", profileImage: "post6", initialLikes: 785634, commentUser: "ShadowLurker", commentText: "That pose again? not creative LOL")
        // Add more posts as needed
    ]
